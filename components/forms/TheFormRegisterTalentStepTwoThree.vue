  		...
  		<div class="container">
					...
					<div class="offset-lg-4 col-lg-16">
						...
						<div class="c-formregistertalent__field">
                        	<label class="--question">Dans quel domaine avez-vous obtenu une spécialisation ? </label>
							<div class="c-formregistertalent__field__radiolist" role="radiogroup">
								<div class="c-formregistertalent__field__radioelement">
									<input type="radio" id="1" name="specialization" value="1" v-model="specialization" role="radio" aria-checked="false"  aria-labelledby="label-1">
									<label id="label-1" for="1" tabindex="0">Agriculture</label>
								</div>
								<div class="c-formregistertalent__field__radioelement">
									<input type="radio" id="2" name="specialization" value="2" v-model="specialization" role="radio" aria-checked="false" aria-labelledby="label-2">
									<label id="label-2" for="2" tabindex="0">Conseil</label>							
								</div>
								<div class="c-formregistertalent__field__radioelement">									
									<input type="radio" id="3" name="specialization" value="3" v-model="specialization" role="radio" aria-checked="false" aria-labelledby="label-3">
...
<script>
	...
	export default {
		...
		mounted() {
			this.specialization = this.$store.state.registertalent.inputSpecialization
		},
		methods: {
			handleSubmit(){
